...
// CLK_DIVIDER is bits 19-0 of PCG_CTLx1.  it's the clock speed divisor
#define CLK_DIVIDER 15360	
...
void initPCGA(void) {
	...
	//*pPCG_CTLA1 = CLK_DIVIDER|CLKASOURCE; 
	*pPCG_CTLA1 = CLK_DIVIDER;
	*pPCG_CTLA0 =  ENCLKA ; 

	// once we have PCLK, we need to come up with a divisor

	// set the rest of the bits accordingly, output is sitting on CLKA_O, send it to a DAI pin
